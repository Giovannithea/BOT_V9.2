    ...
    try {
        ...
        for (const ix of instructions) {
            ...
            if (programId === RAYDIUM_AMM_PROGRAM_ID.toString() && ix.data.length > 0) {
                ...
                let tokenData = {
                    programId: '675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8', // Raydium V2 Program ID
                    ...
                    targetOrders: new PublicKey(indexedAccounts.ammTargetOrders).toString(), // Renamed from ammTargetOrders
                    ammTargetOrders: new PublicKey(indexedAccounts.ammTargetOrders).toString(), // Keep this for backwards compatibility
                    ...
                    wrappedSOLAmount: indexedAccounts.baseMint === WSOL_MINT
                        ...
                        : null,
                    fee: "0.003",
                    // Add the token field here using baseMint
                    token: new PublicKey(indexedAccounts.baseMint).toString(),
                    baseDecimals: 9, // Default values
                    quoteDecimals: 9
                };
